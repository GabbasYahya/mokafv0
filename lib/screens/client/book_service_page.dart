...
class _BookServicePageState extends State<BookServicePage> {
  ...
  // Keep track of unavailable slots
  ...
  Future<void> _loadUnavailableSlots() async {
    try {
      ...
      final bookedSlotsSnapshot = await FirebaseFirestore.instance
          ...
          .where('providerId', isEqualTo: widget.service['providerId'])
  ...
  void _updateAvailableTimeSlots() {
    ...
    final weekday = DateFormat('EEEE').format(_selectedDay).toLowerCase();
    ...
    if (_providerSchedule![weekday] != null && 
      ...
      var currentTime = DateTime(_selectedDay.year, _selectedDay.month, _selectedDay.day, startHour, startMinute);
      final endTime = DateTime(_selectedDay.year, _selectedDay.month, _selectedDay.day, endHour, endMinute);
      
      final serviceDuration = widget.service['duration'] ?? 1;
  ...
  bool _isDayAvailable(DateTime day) {
    ...
    // Handle null provider schedule or missing weekday entries
  ...
  Future<void> _bookService() async {
    ...
    try {
      ...
      final duration = widget.service['duration'] ?? 1;
      ...
      await FirebaseFirestore.instance
          ...
          .add({
            ...
            'message': 'You have a new booking request for ${widget.service['name']} on ${DateFormat('MMM d, yyyy').format(_selectedDay)} at $_selectedTimeSlot.',
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => BookingConfirmationPage(bookingId: bookingRef.id),
        ),
      );
    } catch (e) {
          ...
          : Form(
              ...
              child: ListView(
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                'Provider: ${widget.service['providerName'] ?? 'Provider'}',
                                style: TextStyle(
                                  fontSize: 16,
                              ...
                              Text(
                                '\$${(widget.service['price'] as num?)?.toStringAsFixed(2) ?? '0.00'}',
                                style: TextStyle(
                                  fontSize: 18,
                                  fontWeight: FontWeight.bold,
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'Duration: ${widget.service['duration'] ?? 1} hour(s)',
                            style: TextStyle(
                              fontSize: 16,
                              color: Colors.grey[700],
                            ),
                  ...
                  // Book button
                  ElevatedButton(
                    onPressed: _isSubmitting ? null : _bookService,
